        ...
        if (selectedStatus === "All") {
            $.ajax({
                ...
                success: function (data) {
                    window.location.href = "/Admin/Complains/Index?page=" + currentPage + "&nameuser=" + textsearch + "&createdat=" + selectedCreatedAt;
                },
                error: function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    window.location.href = "/Admin/Complains/Index?page=" + currentPage + "&nameuser=" + textsearch + "&status=" + selectedStatus + "&createdat=" + selectedCreatedAt;
                },
                error: function () {
                    console.log('Đã xảy ra lỗi khi gửi yêu cầu lọc.');
                }
